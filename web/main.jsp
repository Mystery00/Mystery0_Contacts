...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" id="menu-toggle" class=" navbar-btn collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
         <li><button class="btn btn-default" id="delete"style="display:none; margin:10px 0px;">删除</button></li>
        <li class="dropdown">
            ...
            <div class="tel-list">
            	<div class="list-item list-item1">
            		<div class="tel-listIcon">
            			<img src="https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5MN3ESuFcwTdJhvSQWNPBg6QIhgKABD___________8BGJ7Szfn______wE/s36-p-k-rw-no/photo.jpg" alt="icon">
            			<div class="check">
